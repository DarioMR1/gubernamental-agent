...
def create_corpus(
    ...
    try:
        ...
        # IMPORTANT: Map user name to actual resource name for later use
        tool_context.state[f"corpus_resource_name_{corpus_name}"] = rag_corpus.name

        # Set this as the current corpus (using the user's name)
